...
$this->menu=array(
	//array('label'=>Yii::t('app','List').'  Sectoress', 'url'=>array('index')),
	array('label'=>Yii::t('app','Nuevo').'  Sector', 'url'=>array('create')),
	//array('label'=>Yii::t('app','View').'  Sectores', 'url'=>array('view', 'id'=>$model->id)),
...
<h3> Actualizar Sector #<?php echo $model->id; ?> 
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    <li class="divider"></li>
    <li>
        <?php echo CHtml::link('Nueva',array('sectores/create')); ?>
    </li>
